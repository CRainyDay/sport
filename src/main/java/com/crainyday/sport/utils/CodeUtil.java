...
public class CodeUtil {
    ...
    public static String getCodeNum() {
    	...
    	for (int i = 0; i < 6; i++) {
    		code.append(String.valueOf(codeSequence[random.nextInt(codeSequence.length - 1)]));
		}
     ...
     * 获取codeCount位图片验证码
     */
    public static void getImgCode(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        // 定义图像buffer
